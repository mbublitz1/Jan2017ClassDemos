...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <asp:DropDownList ID="ArtistDDL" runat="server" DataSourceID="ArtistDDLODS" DataTextField="DisplayText" DataValueField="IDValueField" Width="150px"></asp:DropDownList><br />
            ...
            <asp:DropDownList ID="MediaTypeDDL" runat="server" DataSourceID="MediaTypeDDLODS" DataTextField="DisplayText" DataValueField="IDValueField" Width="150px"></asp:DropDownList><br />
            ...
            <asp:DropDownList ID="GenreDDL" runat="server" DataSourceID="GenreDDLODS" DataTextField="DisplayText" DataValueField="IDValueField" Width="150px"></asp:DropDownList><br />
            ...
            <asp:DropDownList ID="AlbumDDL" runat="server" DataSourceID="AlbumDDLODS" DataTextField="DisplayText" DataValueField="IDValueField" Width="150px"></asp:DropDownList><br />
    ...
    <asp:ObjectDataSource ID="TrackSelectionListODS" runat="server"
        ...
        TypeName="Chinook.System.BLL.TrackController"
