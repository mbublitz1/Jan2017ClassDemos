            ...
            <div class="tab-content">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:ObjectDataSource ID="ArtistListODS" runat="server"
                                ...
                                TypeName="Chinook.System.BLL.ArtistController"></asp:ObjectDataSource>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
                <div class="tab-pane fade" id="lvmaintain">
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>
                            <asp:ListView ID="ListView1" runat="server" DataSourceID="AlbumCRUDODS" InsertItemPosition="LastItem" DataKeyNames="AlbumId" ItemType="Chinook.Data.Entities.Album">
                            ...
                            <asp:ObjectDataSource ID="AlbumCRUDODS" runat="server" DataObjectTypeName="Chinook.Data.Entities.Album"
                                ...
                                OldValuesParameterFormatString="original_{0}"
                                TypeName="Chinook.System.BLL.AlbumController"
                            ...
                            If the tabe was on a page by itself, then I would need to create the ArtistListODS
