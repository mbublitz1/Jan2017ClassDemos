...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:ObjectDataSource ID="AlbumArtistODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ListAlbumsByArtist" TypeName="Chinook.System.BLL.AlbumController"></asp:ObjectDataSource>
</asp:Content>
